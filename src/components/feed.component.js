        ...
        return (<div className="container">
            ...
            <div className="feed-box">
                <div className="feedbox-content">
                    ...
                    <div className="feedbox-author-date row">
                    <div className="feedbox-author col-8">By John Smith</div>
                    <div className="feedbox-date col">15 March 2020</div>
                    </div>
                </div>
            ...
            <div className="feed-box">
                <div className="feedbox-content">
                    ...
                    <div className="feedbox-author-date row">
                    <div className="feedbox-author col-8">By John Smith</div>
                    <div className="feedbox-date col">14 March 2020</div>
                    </div>
                </div>
            ...
            <div className="feed-box">
                <div className="feedbox-content">
                    ...
                    <div className="feedbox-author-date row">
                    <div className="feedbox-author col-8">By John Smith</div>
                    <div className="feedbox-date col">12 March 2020</div>
                    </div>
                </div>
            ...
            <div className="feed-box">
                <div className="feedbox-content">
                    ...
                    <div className="feedbox-author-date row">
                    <div className="feedbox-author col-8">By John Smith</div>
                    <div className="feedbox-date col">10 March 2020</div>
                    </div>
                </div>
